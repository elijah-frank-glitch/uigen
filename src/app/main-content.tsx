          ...
          <ResizablePanelGroup direction="horizontal" className="h-full">
            ...
            <ResizablePanel defaultSize={35} minSize={25} maxSize={50}>
              <div className="h-full flex flex-col bg-white dark:bg-neutral-900">
                {/* Chat Header */}
                <div className="h-14 flex items-center px-6 border-b border-neutral-200/60 dark:border-neutral-800/60">
            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-white dark:bg-neutral-900">
                {/* Top Bar */}
                <div className="h-14 border-b border-neutral-200/60 dark:border-neutral-800/60 px-6 flex items-center justify-between bg-neutral-50/50 dark:bg-neutral-900/50">
                  <Tabs
                    value={activeView}
                    onValueChange={(v) =>
                  ...
                  {activeView === "preview" ? (
                    ...
                    >
                      ...
                      <ResizablePanel
                        ...
                        maxSize={50}
                      >
                        <div className="h-full bg-neutral-50 dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-800">
                          <FileTree />
                        </div>
                      </ResizablePanel>
